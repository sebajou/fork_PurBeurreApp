...
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': os.getenv('SECRET_CLOUD_NAME', 'Optional default value'),
    'API_KEY': os.getenv('SECRET_API_KEY', 'Optional default value'),
    'API_SECRET': os.getenv('SECRET_API_KEY', 'Optional default value'),
}
