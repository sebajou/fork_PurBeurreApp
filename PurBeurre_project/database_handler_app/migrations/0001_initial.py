...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('favorites_list', models.ManyToManyField(blank=True, related_name='favorites', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='myusers',
            name='search_food',
            field=models.ManyToManyField(blank=True, related_name='users', to='database_handler_app.FoodList'),
        ),
        migrations.AddField(
            model_name='myusers',
